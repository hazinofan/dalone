  ...
  return (
    <Combobox value={value} onChange={onChange}>
      <div className="relative">
        ...
        >
          <div className="absolute mt-1 max-h-60 w-full overflow-auto rounded bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
            <Combobox.Options>
              {filtered.length === 0 ? (
